...
{
    public class RoleModuleRepository : RepositoryBase<RoleModule>, IRoleModuleRepository
    {        
        ...
        public RoleModuleRepository(IAuthorityRepositoryContext repositoryContext)
