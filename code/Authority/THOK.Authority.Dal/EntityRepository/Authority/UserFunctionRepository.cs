...
{
    public class UserFunctionRepository : RepositoryBase<UserFunction>, IUserFunctionRepository
    {        
        public UserFunctionRepository()
            : this(new AuthorityRepositoryContext())
        {
        }

        public UserFunctionRepository(IAuthorityRepositoryContext repositoryContext)
