...
{
    public class RoleFunctionRepository : RepositoryBase<RoleFunction>, IRoleFunctionRepository
    {
        ...
        public RoleFunctionRepository(IAuthorityRepositoryContext repositoryContext)
