namespace THOK.Wms.Repository.Migrations
{
    ...
    public partial class modify_datatype_nullable : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.wms_in_bill_detail", "id", c => c.Long(nullable: false, identity: true));
            AlterColumn("dbo.wms_in_bill_allot", "id", c => c.Long(nullable: false, identity: true));
            ...
            AlterColumn("dbo.wms_out_bill_detail", "id", c => c.Long(nullable: false, identity: true));
            AlterColumn("dbo.wms_out_bill_allot", "id", c => c.Long(nullable: false, identity: true));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.wms_out_bill_allot", "id", c => c.Int(nullable: false, identity: true));
            AlterColumn("dbo.wms_out_bill_detail", "id", c => c.Int(nullable: false, identity: true));
            ...
            AlterColumn("dbo.wms_in_bill_allot", "id", c => c.Int(nullable: false, identity: true));
            AlterColumn("dbo.wms_in_bill_detail", "id", c => c.Int(nullable: false, identity: true));
