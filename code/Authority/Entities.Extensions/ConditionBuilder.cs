...
namespace Entities.Extensions
{
	internal class ConditionBuilder : ExpressionVisitor
	{
        ...
        public void Build(Expression expression, TableMetadata tableMetadata)
		{
		...
		protected override Expression VisitMemberAccess(MemberExpression m)
		{
            ...
            this.m_conditionParts.Push(String.Format("[{0}]", m_tableMetadata.Properties[propertyInfo.Name].Name));
			return m;
		}
