...
namespace Entities.Extensions
{
    public class TableMetadata
    {
        ...
        public static TableMetadata GetTableMetadata<TEntity>(ObjectSet<TEntity> source) where TEntity : class
        {
            ...
            tableMetadata.Name = tableMetadata.EntitySet.GetType().InvokeMember("CachedProviderSql", BindingFlags.GetProperty | BindingFlags.NonPublic | BindingFlags.Instance, null, tableMetadata.EntitySet, null) as string;
